...
class LastBuildCategoryWithQuestions extends StatelessWidget {
  final CategoryModel categoryModel;
  const LastBuildCategoryWithQuestions({
          ...
          return LastQuestionItem(
            ...
            onAnswer: (answer) {
              ...
              if (index == -1) {
                ...
                BlocProvider.of<QuestionsCubit>(context)
                    .lastCategoryAnswers[index] = answer;
              }
            },
          );
        }),
