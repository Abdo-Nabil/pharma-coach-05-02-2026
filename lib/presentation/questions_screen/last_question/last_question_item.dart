...
class LastQuestionItem extends StatefulWidget {
  final QuestionModel questionModel;
  final Function onAnswer;
  const LastQuestionItem({
    required this.questionModel,
    required this.onAnswer,
  });

  @override
  State<LastQuestionItem> createState() => _LastQuestionItemState();
}

class _LastQuestionItemState extends State<LastQuestionItem>
