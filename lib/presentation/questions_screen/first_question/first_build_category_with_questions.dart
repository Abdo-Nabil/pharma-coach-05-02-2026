...
import 'first_question_item.dart';

class FirstBuildCategoryWithQuestions extends StatelessWidget {
  final CategoryModel categoryModel;
  const FirstBuildCategoryWithQuestions({
    ...
    return Column(
      children: [
        ...
        ...List.generate(categoryModel.questions.length, (index) {
          final temp = index;
          return FirstQuestionItem(
            questionModel: categoryModel.questions[index],
            onAnswer: (answer) {
              int index = BlocProvider.of<FirstQuestionCubit>(context)
                  .answers
                  .indexWhere((element) =>
                      element.categoryId ==
              ...
              if (index == -1) {
                ...
                BlocProvider.of<FirstQuestionCubit>(context).answers[index] =
                    answer;
              }
            },
          );
